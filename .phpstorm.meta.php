...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\ClassroomRepository' => \App\Repositories\ClassroomRepositoryEloquent::class,
            'App\Repositories\CourseRepository' => \App\Repositories\CourseRepositoryEloquent::class,
            'App\Repositories\StudentRepository' => \App\Repositories\StudentRepositoryEloquent::class,
            'App\Repositories\UserRepository' => \App\Repositories\UserRepositoryEloquent::class,
            'App\Services\Interfaces\ClassroomServiceInterface' => \App\Services\ClassroomService::class,
            'App\Services\Interfaces\CourseServiceInterface' => \App\Services\CourseService::class,
            'App\Services\Interfaces\StudentServiceInterface' => \App\Services\StudentService::class,
    ...
    override(\config(), map([
            ...
            'breadcrumb.dashboard.index' => 'string',
            'breadcrumb.user.index' => 'string',
            'breadcrumb.user.create' => 'string',
            'breadcrumb.user.edit' => 'string',
            'breadcrumb.user.delete' => 'string',
            'breadcrumb.student.index' => 'string',
            'breadcrumb.student.create' => 'string',
            'breadcrumb.student.edit' => 'string',
            'breadcrumb.student.delete' => 'string',
            'breadcrumb.course .index' => 'string',
            'breadcrumb.course .create' => 'string',
            'breadcrumb.course .edit' => 'string',
            'breadcrumb.course .delete' => 'string',
            'breadcrumb.class.index' => 'string',
            'breadcrumb.class.create' => 'string',
            'breadcrumb.class.edit' => 'string',
            'breadcrumb.class.delete' => 'string',
            ...
            'filesystems.links./home/khanhhoa/sites/CRM/public/storage' => 'string',
...
'session.partitioned','app.name','app.env','app.debug','app.url',
...
'breadcrumb.dashboard.index','breadcrumb.user.index','breadcrumb.user.create','breadcrumb.user.edit','breadcrumb.user.delete',
'breadcrumb.student.index','breadcrumb.student.create','breadcrumb.student.edit','breadcrumb.student.delete','breadcrumb.course .index',
'breadcrumb.course .create','breadcrumb.course .edit','breadcrumb.course .delete','breadcrumb.class.index','breadcrumb.class.create',
'breadcrumb.class.edit','breadcrumb.class.delete','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/khanhhoa/sites/CRM/public/storage','logging.default','logging.deprecations.channel',
...
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','repository.pagination.limit',
'repository.fractal.params.include','repository.fractal.serializer','repository.cache.enabled','repository.cache.minutes','repository.cache.repository',
'repository.cache.clean.enabled','repository.cache.clean.on.create','repository.cache.clean.on.update','repository.cache.clean.on.delete','repository.cache.params.skipCache',
'repository.cache.allowed.only','repository.cache.allowed.except','repository.criteria.acceptedConditions','repository.criteria.params.search','repository.criteria.params.searchFields',
'repository.criteria.params.filter','repository.criteria.params.orderBy','repository.criteria.params.sortedBy','repository.criteria.params.with','repository.criteria.params.searchJoin',
'repository.criteria.params.withCount','repository.generator.basePath','repository.generator.rootNamespace','repository.generator.stubsOverridePath','repository.generator.paths.models',
'repository.generator.paths.repositories','repository.generator.paths.interfaces','repository.generator.paths.transformers','repository.generator.paths.presenters','repository.generator.paths.validators',
'repository.generator.paths.controllers','repository.generator.paths.provider','repository.generator.paths.criteria','sanctum.stateful','sanctum.guard',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','table.user','debugbar.enabled','debugbar.hide_empty_tabs',
...
'signed','throttle','verified','isManager',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.clockwork','debugbar.assets.css','debugbar.assets.js','debugbar.cache.delete',
'debugbar.queries.explain','sanctum.csrf-cookie','search.navbar',
'dashboard','profile.edit','profile.update','profile.destroy','logout',
'user.index','user.create','user.store','user.edit','user.update',
'user.delete','user.destroy','user.profile','user.filter','student.index',
'student.create','student.store','student.edit','student.update','student.delete',
'student.destroy','student.filter','profile.index','student.tuition.update','course.index',
'course.create','course.store','course.edit','course.update','course.delete',
'course.destroy','course.filter','classroom.index','classroom.create','classroom.store',
'classroom.edit','classroom.update','classroom.delete','classroom.destroy','classroom.filter',
'activate.register.user','register','login',
...
'auth.verify-email','backend.classroom.components.filter','backend.classroom.components.table','backend.classroom.create','backend.classroom.delete',
'backend.classroom.edit','backend.classroom.index','backend.course.components.filter','backend.course.components.table','backend.course.create',
'backend.course.delete','backend.course.edit','backend.course.index','backend.dashboard.components.footer','backend.dashboard.components.head',
'backend.dashboard.components.navbar','backend.dashboard.components.script','backend.dashboard.components.sidebar','backend.dashboard.index','backend.student.components.filter',
'backend.student.components.table','backend.student.create','backend.student.delete','backend.student.edit','backend.student.index',
'backend.student.profile','backend.user.components.filter','backend.user.components.table','backend.user.create','backend.user.delete',
'backend.user.edit','backend.user.index','backend.user.profile','components.application-logo','components.auth-session-status',
...
'components.text-input','dashboard','emails.activate_user','layouts.admin','layouts.app',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','flasher::messages.success',
'flasher::messages.error','flasher::messages.warning','flasher::messages.info','flasher::messages.The resource was created','flasher::messages.The resource was updated',
'flasher::messages.The resource was saved','flasher::messages.The resource was deleted','flasher::messages.resource','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.cn.criteria.fields_not_accepted','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.cn.packages.prettus_laravel_validation_required',
'repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.cn.packages.league_fractal_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.en.criteria.fields_not_accepted','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.en.packages.prettus_laravel_validation_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.en.packages.league_fractal_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.it.criteria.fields_not_accepted',
'repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.it.packages.prettus_laravel_validation_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.it.packages.league_fractal_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.nl.criteria.fields_not_accepted','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.nl.packages.prettus_laravel_validation_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.nl.packages.league_fractal_required',
'repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.pt-br.criteria.fields_not_accepted','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.pt-br.packages.prettus_laravel_validation_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.pt-br.packages.league_fractal_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.pt.criteria.fields_not_accepted','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.pt.packages.prettus_laravel_validation_required',
'repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.pt.packages.league_fractal_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.ro.criteria.fields_not_accepted','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.ro.packages.prettus_laravel_validation_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.ro.packages.league_fractal_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.zh_CN.criteria.fields_not_accepted',
'repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.zh_CN.packages.prettus_laravel_validation_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.zh_CN.packages.league_fractal_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.zh_TW.criteria.fields_not_accepted','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.zh_TW.packages.prettus_laravel_validation_required','repository::.home.khanhhoa.sites.CRM.vendor.prettus.l5-repository.src.resources.lang.zh_TW.packages.league_fractal_required',);
