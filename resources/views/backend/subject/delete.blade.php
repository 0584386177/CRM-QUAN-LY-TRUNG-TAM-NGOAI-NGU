...
<div class="card card-primary card-outline mb-4 " bis_skin_checked="1"> <!--begin::Header-->
    ...
    <form method="POST" action="{{route('subject.destroy', $subject->id)}}"> @csrf <!--begin::Body-->
        <div class="card-body">
            <div class="row"> <!-- Cột trái -->
                <div class="col-md-6">
                    <div class="mb-3"> <label for="fullname" class="form-label">Tên môn học</label> <input readonly
                            type="text" name="name" value="{{$subject->name}}" class="form-control"> </div>


                </div> <!-- Cột phải -->
                <div class="col-md-6">
                    <div class="mb-3"> <label class="form-label">Giáo viên phụ trách</label>
                        <input readonly type="email" name="teacher_id" value="{{$subject->teacher_id}}"
                            class="form-control">
                    </div>
                </div>
            </div>
