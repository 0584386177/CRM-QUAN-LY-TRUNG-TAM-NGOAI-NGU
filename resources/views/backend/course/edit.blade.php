            ...
            <div class="row"> <!-- Cột trái -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3"> <label class="form-label">Số buổi học</label> <input type="text"
                            name="number_of_lessions" value="{{$course->number_of_lessions}}" class="form-control">
                    </div>
